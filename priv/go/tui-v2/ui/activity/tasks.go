...
// msg.ToggleExpand toggles the expanded detail view (shows ActiveForm).
...
// Reset clears all tasks and resets the expanded state.
...
// Update handles msg.ToggleExpand to show/hide ActiveForm detail.
func (m TasksModel) Update(message interface{}) TasksModel {
...
// View renders the task checklist with ⎿ connector. Returns "" when empty.

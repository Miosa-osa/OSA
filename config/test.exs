...
# Stable shared secret for test token generation/verification — generated per test run
config :optimal_system_agent, shared_secret: "osa-test-#{:crypto.strong_rand_bytes(16) |> Base.url_encode64(padding: false)}"

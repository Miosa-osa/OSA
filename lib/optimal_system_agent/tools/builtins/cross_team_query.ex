defmodule OptimalSystemAgent.Tools.Builtins.CrossTeamQuery do
  ...
  All logic lives in `lib/optimal_system_agent/tools/builtins/cross_team_query/`.
  This module is kept for registry backwards-compatibility and for tests
  that alias `CrossTeamQuery` directly; it forwards every callback to
  `CrossTeamQuery.Tool`.
  """

  @tool OptimalSystemAgent.Tools.Builtins.CrossTeamQuery.Tool

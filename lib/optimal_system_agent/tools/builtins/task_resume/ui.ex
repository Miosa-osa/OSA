defmodule OptimalSystemAgent.Tools.Builtins.TaskResume.UI do
  @moduledoc """
  Render maps for the Rust TUI.

  Mirrors `TaskStop.UI` in structure. Each `render/3` call returns a

defmodule OptimalSystemAgent.Tools.Builtins.TaskStop do
  ...
  The real implementation lives in:
      ...
      lib/optimal_system_agent/tools/builtins/task_stop/
  ...
  1. The registry keeps the same atom `OptimalSystemAgent.Tools.Builtins.TaskStop`.
  2. Existing test aliases (`alias ... TaskStop`) continue to resolve.
  """

  @behaviour OptimalSystemAgent.Tools.Behaviour

  alias OptimalSystemAgent.Tools.Builtins.TaskStop.Tool

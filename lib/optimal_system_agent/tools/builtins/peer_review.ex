defmodule OptimalSystemAgent.Tools.Builtins.PeerReview do
  ...
  All logic lives in `lib/optimal_system_agent/tools/builtins/peer_review/`.
  This module is kept for registry backwards-compatibility and for tests
  that alias `PeerReview` directly; it forwards every callback to
  `PeerReview.Tool`.
  """

  @tool OptimalSystemAgent.Tools.Builtins.PeerReview.Tool

defmodule OptimalSystemAgent.Tools.Builtins.ListSkills do
  ...
  All logic lives under `lib/optimal_system_agent/tools/builtins/list_skills/`:

    * `ListSkills.Tool`      — `use OptimalSystemAgent.Tools.Behaviour`, declarations
  ...
  This module preserves the `OptimalSystemAgent.Tools.Builtins.ListSkills` atom
  so that existing registry entries, config references, and test aliases
  continue to resolve without modification.
  """

  @tool OptimalSystemAgent.Tools.Builtins.ListSkills.Tool

defmodule OptimalSystemAgent.Tools.Builtins.PeerClaimRegion do
  ...
  All logic lives in `lib/optimal_system_agent/tools/builtins/peer_claim_region/`.
  This module is kept for registry backwards-compatibility and for tests
  that alias `PeerClaimRegion` directly; it forwards every callback to
  `PeerClaimRegion.Tool`.
  """

  @tool OptimalSystemAgent.Tools.Builtins.PeerClaimRegion.Tool

defmodule OptimalSystemAgent.Agent.Loop.Guardrails do
  ...
  This is intentionally signal-based instead of matching one exact sentence:
  it combines an observation verb with a visible-surface noun, or accepts
  direct "look" requests that refer to the current shared UI.
  """
